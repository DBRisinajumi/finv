...
<div class="btn-toolbar">
        ...
        <?php
                   switch($this->action->id) {
                       case "create":
                        ...
                        "icon"=>"icon-list-alt",
                        "url"=>array("admin"),
                        "visible"=>Yii::app()->user->checkAccess("Finv.FinvInvoice.View")
                    ));
                    break;
                case "admin":
                    $this->widget("bootstrap.widgets.TbButton", array(
                        ...
                        "icon"=>"icon-plus",
                        "url"=>array("create"),
                        "visible"=>Yii::app()->user->checkAccess("Finv.FinvInvoice.Create")
                    ));
                    break;
                case "view":
                    $this->widget("bootstrap.widgets.TbButton", array(
                    ...
                    $this->widget("bootstrap.widgets.TbButton", array(
                        ...
                        "visible"=>Yii::app()->user->checkAccess("Finv.FinvInvoice.Update")
                    ));
                    $this->widget("bootstrap.widgets.TbButton", array(
                        "label"=>Yii::t("FinvModule.crud_static","Create"),
                        "icon"=>"icon-plus",
                    ...
                    $this->widget("bootstrap.widgets.TbButton", array(
                        ...
                        "visible"=>Yii::app()->user->checkAccess("Finv.FinvInvoice.Delete")
                    ));
                    break;
                case "update":
                    $this->widget("bootstrap.widgets.TbButton", array(
    ...
    <?php if($this->action->id == 'admin' || $this->action->id == 'view'): ?>            <div class="btn-group">
            <?php $this->widget('bootstrap.widgets.TbButtonGroup', array(
                   'buttons' => array(
                           array('label'=>Yii::t('FinvModule.crud_static','Relations'), 'icon'=>'icon-random', 'items'=>array(array('icon' => 'arrow-right','label' => 'FiitInvoiceItems', 'url' =>array('/finv/fiitInvoiceItem/admin')),array('icon' => 'circle-arrow-left','label' => 'FinvIssuerCcmp', 'url' =>array('/finv/ccmpCompany/admin')),array('icon' => 'circle-arrow-left','label' => 'FinvPayerCcmp', 'url' =>array('/finv/ccmpCompany/admin')),array('icon' => 'circle-arrow-left','label' => 'FinvFcrn', 'url' =>array('/finv/fcrnCurrency/admin')),array('icon' => 'circle-arrow-left','label' => 'FinvBasicFcrn', 'url' =>array('/finv/fcrnCurrency/admin')),array('icon' => 'circle-arrow-left','label' => 'FinvStst', 'url' =>array('/finv/ststState/admin')),
            )
          ),
        ),
    ));
